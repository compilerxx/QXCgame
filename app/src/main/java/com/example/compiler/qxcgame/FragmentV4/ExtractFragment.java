...
//        Button button = (Button) getActivity().findViewById(R.id.first_bit_0);
//        button.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                TextView textView = (TextView) getActivity().findViewById(R.id.text_select_num);
//                textView.setText("Test Fragment yjy");
//
//            }
//        });

        final EditText mSelectCount = (EditText)getActivity().findViewById(R.id.edit_select_count);
        Button mSelectCode = (Button)getActivity().findViewById(R.id.select_code);
        Button mResetSelectCode = (Button)getActivity().findViewById(R.id.reset_select_code);
        final TextView mShowSelectCode = (TextView)getActivity().findViewById(R.id.text_select_num);

        Button firstBit0 = (Button)getActivity().findViewById(R.id.first_bit_0);
        Button firstBit1 = (Button)getActivity().findViewById(R.id.first_bit_1);
        Button firstBit2 = (Button)getActivity().findViewById(R.id.first_bit_2);
        Button firstBit3 = (Button)getActivity().findViewById(R.id.first_bit_3);
        Button firstBit4 = (Button)getActivity().findViewById(R.id.first_bit_4);
        Button firstBit5 = (Button)getActivity().findViewById(R.id.first_bit_5);
        Button firstBit6 = (Button)getActivity().findViewById(R.id.first_bit_6);
        Button firstBit7 = (Button)getActivity().findViewById(R.id.first_bit_7);
        Button firstBit8 = (Button)getActivity().findViewById(R.id.first_bit_8);
        Button firstBit9 = (Button)getActivity().findViewById(R.id.first_bit_9);

        Button fourthBit0 = (Button)getActivity().findViewById(R.id.fourth_bit_0);
        Button fourthBit1 = (Button)getActivity().findViewById(R.id.fourth_bit_1);
        Button fourthBit2 = (Button)getActivity().findViewById(R.id.fourth_bit_2);
        Button fourthBit3 = (Button)getActivity().findViewById(R.id.fourth_bit_3);
        Button fourthBit4 = (Button)getActivity().findViewById(R.id.fourth_bit_4);
        Button fourthBit5 = (Button)getActivity().findViewById(R.id.fourth_bit_5);
        Button fourthBit6 = (Button)getActivity().findViewById(R.id.fourth_bit_6);
        Button fourthBit7 = (Button)getActivity().findViewById(R.id.fourth_bit_7);
        Button fourthBit8 = (Button)getActivity().findViewById(R.id.fourth_bit_8);
        Button fourthBit9 = (Button)getActivity().findViewById(R.id.fourth_bit_9);
